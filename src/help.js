...
◪ *INFO*
  ❏ Prefixo: 「  ${prefix}  」
  ❏ Criador: 𝐓𝐑𝐀𝐒𝐇 𝐀𝐋𝐋𝐀𝐇𝐔
◪ *SOBRE* 
  │
  ├─ ❏ ${prefix}instagram : OFF

  ├─ ❏ ${prefix}blocklist
  ├─ ❏ ${prefix}SFDR RANDOWN KKKKK
  ├─ ❏ ${prefix} numero whatsapp wa.me/559288558765
  └─ ❏ ${prefix}telegram : OFF
...
◪ *SONS*
  │
  ├─ ❏ ${prefix}play  .play comando pra baixa musica 😳 .play mais nome da musica
  └─ ❏ ${prefix}tts
◪ *MUSICA*
  │
  ├─ ❏ ${prefix}lirik
